...
/** @typedef {'HOST_UNRESOLVED'|'BAD_REMOTE_URL'|'BAD_CONFIG_FILE'|'BAD_SEVERITY_PATTERN'|'NO_CREDENTIAL'|'UNAUTHORIZED'|'FORBIDDEN'|'NOT_FOUND'|'HTTP_ERROR'|'SSH_FAILED'|'UNSAFE_QUERY'|'UNSAFE_CONNECTION'|'BAD_RESPONSE'|'GERRIT_ERROR'|'STORE_FAILED'|'NO_TTY'|'EMPTY_TOKEN'} ErrorCode */
